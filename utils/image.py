...
def create_image(quote: str, image_url: str, color: tuple) -> None:
    ...
    T_IMG_NAME = path.join(gettempdir(),
                       f'qimage-{TIMESTAMP}.jpg')
    ...
    ImageDraw.Draw(img).text((382, 719), quote['a'], (0, 0, 0), font=afont) # Add author
    ImageDraw.Draw(img).text((131, 833), textwrap.fill(quote['q'], 30), (0, 0, 0), font=qfont) # Add quote
